...
<<<<<<< Updated upstream
    ...
    script.src = 'https://somasekhar-nakkala.github.io/'+
        'callback=' + callbackName + '&project=Somasekhar-nakkala.github.io&page=&theme=material&format=jsonp&docroot=docs&source_suffix=.md&version=' + (window['MKDOCS_DATA'] || { version: 'latest' }).version;
